...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addressInput.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(phoneInput, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel3)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(ageInput, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
                                .addGap(24, 24, 24))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(pwdInput, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ageInput, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void signupButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupButtonActionPerformed
        ...
        } else if (!phoneText.matches("\\d{10,15}")) { // Phone number should be 10-15 digits
            errors.append("Phone number should contain only digits and be 10-15 characters long.\n");
        }
        ...
        if (ageText.isEmpty()) {
            ...
            try {
                ...
                if (age < 1 || age > 120) { // Age range
                    errors.append("Age should be between 1 and 120.\n");
                }
            } catch (NumberFormatException e) {
                errors.append("Age should be a valid number.\n");
            }
        }
        ...
        } else if (address.length() > 255) { // Maximum address length
            errors.append("Address should not exceed 255 characters.\n");
        }
