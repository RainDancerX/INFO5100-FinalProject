 ...
 * @author lucas
 */
public class VendorMgm extends javax.swing.JPanel {

    /**
     * Creates new form VendorMgm
     */
    public VendorMgm() {
        initComponents();

        vendorTable.getTableHeader().setFont(new java.awt.Font("Helvetica Neue", java.awt.Font.BOLD, 13));
        loadAssociateData();
    }
    ...
    private void loadAssociateData() {
        ...
        String query = "SELECT vendorId, username, password FROM vendor";
        ...
        try (Connection connection = DatabaseConnection.getConnection(); PreparedStatement statement = connection.prepareStatement(query); ResultSet resultSet = statement.executeQuery()) {
            ...
            while (resultSet.next()) {
                int associateId = resultSet.getInt("vendorId");
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(788, 436));

        vendorTable.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        vendorTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        vendorTable.setRowHeight(30);
        jScrollPane1.setViewportView(vendorTable);
        if (vendorTable.getColumnModel().getColumnCount() > 0) {
            vendorTable.getColumnModel().getColumn(0).setMinWidth(30);
            vendorTable.getColumnModel().getColumn(0).setPreferredWidth(30);
            vendorTable.getColumnModel().getColumn(0).setMaxWidth(30);
        }
    ...
    private void deleteBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtn1ActionPerformed
        ...
        if (selectedRow == -1) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please select an vendor to delete.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try (Connection connection = DatabaseConnection.getConnection(); PreparedStatement statement = connection.prepareStatement(deleteQuery)) {
            ...
            if (rowsAffected > 0) {
                javax.swing.JOptionPane.showMessageDialog(this, "Vendor deleted successfully.", "Success", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                // Remove the row from the table model
                model.removeRow(selectedRow);
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "Failed to delete the vendor.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            }

        } catch (SQLException e) {
            e.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this, "An error occurred while deleting the vendor.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
